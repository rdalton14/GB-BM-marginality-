...
STACK_PATH = (
    ...
    / "bid_offer_stack_energy_q1_2026_long.parquet"
)
NIV_PATH = (
    PROJECT_ROOT
...
BMU_MAP_PATH = OUT_DIR / "bid_offer_stack_energy_q1_2026_bmu_map.csv"
REGISTER_PATH = PROJECT_ROOT / "data" / "raw" / "reference" / "bmu_register_q1_2026.csv"
OUT_LONG = OUT_DIR / "bid_offer_stack_energy_q1_2026_niv_marginal.parquet"
OUT_SP = OUT_DIR / "bid_offer_stack_energy_q1_2026_niv_marginal_sp_summary.parquet"
...
def main() -> None:
    print("Loading Q1 2026 bid-offer stack ...")
    ...
    assert REGISTER_PATH.exists(), f"Register not found: {REGISTER_PATH} — run build_bmu_register_q1_2026.py first"
