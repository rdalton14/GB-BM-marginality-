...
$ProcessedCsv = Join-Path $ProcessedDir "system_price_niv_q1_2026.csv"
$DailyCompletenessCsv = Join-Path $DiagnosticsCoverageDir "system_price_niv_q1_2026_daily_completeness.csv"
$MissingSpsCsv = Join-Path $DiagnosticsMissingnessDir "system_price_niv_q1_2026_missing_sps.csv"
