...
OUT_HTML = PROJECT_ROOT / "reports" / "q1_2026" / "canonical" / "rf_price_importance_q1_2026_sided.html"
...
def desc_table(sp: pd.DataFrame, sided_col: str) -> str:
    tbl = (
...
<section>
  ...
  <h3>Descriptive stats (top {TOP_N} by median)</h3>
  {desc_table(sp, sided_col)}
...
<title>RF Price Importance (Sided) — Q1 2026</title>
{CSS}
</head><body>
<h1>RF Feature Importance: System Price ~ Marginal Identity × NIV Side — Q1 2026</h1>
