...
IMPORTANCE_CSV = (
    ...
    / "rf_fullsample_filtered"
    / "offer_side_generator_filtered_rf_feature_importance.csv"
)
LOOKUP_CSV = (
    PROJECT_ROOT
    / "data"
...
OUTPUT_CSV = (
    ...
    / "offer_side_generator_matrices"
    / "rf_fullsample_filtered"
    / "offer_side_generator_filtered_rf_feature_importance_enriched.csv"
)
...
def main() -> None:
    ...
    print(f"Saved enriched importance file to: {OUTPUT_CSV}")
